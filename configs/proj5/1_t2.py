...
parser.add_option('--perceptron_tablesz140', action="store_true")
parser.add_option('--perceptron_tablesz340', action="store_true")
parser.add_option('--perceptron_hislen24', action="store_true")
parser.add_option('--perceptron_hislen44', action="store_true")
parser.add_option('--perceptron_thre109', action="store_true")
parser.add_option('--perceptron_thre49', action="store_true")
parser.add_option('--multiperspectiveperceptron', action="store_true")
...
if options.perceptron_hislen44:
	root.system.cpu.branchPred = PerceptronBP_hislen44()
elif options.perceptron_hislen24:
	root.system.cpu.branchPred = PerceptronBP_hislen24()
elif options.perceptron_thre109:
	root.system.cpu.branchPred = PerceptronBP_thre109()
elif options.perceptron_thre49:
	root.system.cpu.branchPred = PerceptronBP_thre49()
elif options.perceptron_tablesz340:
	root.system.cpu.branchPred = PerceptronBP_tablesz340()
elif options.perceptron_tablesz140:
	root.system.cpu.branchPred = PerceptronBP_tablesz140()
elif options.multiperspectiveperceptron:
	root.system.cpu.branchPred = MultiperspectivePerceptron8KB()
elif options.perceptron:
	root.system.cpu.branchPred = PerceptronBP()
elif options.mysimple:
...
root.system.cpu.max_insts_any_thread = 200000000
